...
const SEED_HOLDINGS = [
  { id: "btc",  name: "BTC",  group: "BTC",    type: "live", coin: "bitcoin",  qty: 0.97363312,     costUSD: 67924, sold: false },
...
const STORAGE_KEY = "folio-dashboard-v6";
...
export default function App() {
  ...
  const [setP, setSetP] = useState({ CPAXT: 15.20, JCK: 0.13, KEX: null, SCGP: 23.60, TRUE: 13.80 });
...
function AllocBars({ alloc, grand, hov, onHov, onSelect }) {
  ...
  return (
    <div className="bars-card card">
      ...
      <div style={{ marginTop: 18, fontSize: 11, color: "var(--fg4)", fontFamily: "'JetBrains Mono',monospace" }}>Tap a category to see its holdings.</div>
    </div>
  );
}

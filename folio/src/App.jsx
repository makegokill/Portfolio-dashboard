...
@media(max-width:640px){
  .pnl-table td,.pnl-table th{padding:10px 6px;font-size:12px}
  .pnl-table th{font-size:9px;letter-spacing:.04em}
  .g-row td{padding:11px 6px} .item-row td{padding-left:16px}
  .g-name{font-size:13px;gap:6px} .h-ct{display:none}
...
@media(max-width:480px){
  ...
  .pnl-table td:first-child{font-size:14px}
  .pnl-hdr-cv{font-size:0}
  .pnl-hdr-cv::after{content:"VALUE";font-size:9px}
}

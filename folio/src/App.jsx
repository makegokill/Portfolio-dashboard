...
.pnl-table th { padding:12px 14px; font-size:11px; font-weight:700; text-transform:uppercase; letter-spacing:.08em; color:var(--fg4); text-align:right; background:var(--bg-inset); white-space:nowrap; }
.pnl-table th:first-child { text-align:left; }
.pnl-table td { padding:11px 14px; font-family:'JetBrains Mono',monospace; font-size:14px; font-feature-settings:"tnum"; white-space:nowrap; text-align:right; color:var(--fg1); }
...
@media(max-width:640px){
  .pnl-table td,.pnl-table th{padding:10px 8px;font-size:10px}
  .pnl-table th{font-size:9px;letter-spacing:.03em}
  .g-row td{padding:11px 8px} .item-row td{padding-left:14px}
  .g-name{font-size:9px;gap:4px} .h-ct{display:none}
  .g-dot,.bar-pip{width:5px;height:5px}
  ...
  .item-row td:first-child{background:#080a11;padding-left:10px;}
